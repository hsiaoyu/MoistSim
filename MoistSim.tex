...
\vspace{0.1in}
\noindent \textbf{Isotropic Growth}: In many cases growth is isotropic and uniform through the thickness of the shell (for instance, when plastic shrinks in response to heat, or biological tissue grows through cell division). In this case 
...
\begin{minipage}[t]{0.45\linewidth} 
    ...
    \caption{Distance between solutions using thin shell simulations using our method (left), and our method with hinge-based shape operator (right), compared to FEM for meshes with 1277, 3594, and 5538 vertices.}
...
We thank Yotam Gingold and Eitan Grinpspun for advice on adapting the hinge-based shape operator for non-Euclidean geometry, and Josh Vekhter for help creating figures.
