...
\section{Validations}
To validate our method, we compare our energy with the energy proposed by Gingold ~\shortcite{Gingold04} which is later adopted in Arcsim ~\cite{Narain:2013:FCA} and the energy of the St. Vernant-Kirchoff model of a thin slab of material. Since the method by Gingold does not support growth intrinsically, we compute the rest curvature based on our method and derived the rest angle for the geometry.  
...
and show the energy comparison in Table~\ref{tab:energy}. Our energy follows closely to the St. Vernant-Kirhoff energy compared to the method by ~\cite{Gingold04} and converges faster than FEM.
