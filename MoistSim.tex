...
\begin{figure}[h]
  ...
  \includegraphics[width=\linewidth]{Annuli_noMD.png}
    \caption{The figure shows the curling behavior of moist paper annuli as they dry. The amount of curling is dependent on the thickness of the paper annuli. From left to right, the thicknesses of the annuli are 0.05 mm, 0.1 mm, 0.2 mm, and 0.5mm. }
  \label{Annuli_noMD}
\end{figure}
