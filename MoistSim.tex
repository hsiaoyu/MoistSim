...
\hline
True Volumetric Energy & $1.6\times10^{-6}$ & $5.64\times10^{-5}$ & $1.55\times10^{-4}$ & $3.87\times10^{-4}$ & $5.974\times10^{-4}$ & $4.77\times10^{-3}$ & $1.2\times10^{-2}$ \\
Thin Limit Approximation & XXX &\\
\hline
Our Energy & $1.6\times10^{-6}$ & $5.77\times10^{-5}$ & $1.6\times10^{-4}$ & $4.1\times10^{-4}$ & $6.4\times10^{-4}$ & $5.67\times10^{-3}$ & $1.54\times10^{-2}$ \\
Hinge-based Formulation & $2.2\times10^{-6}$ & $8.01\times10^{-5}$ & $2.29\times10^{-4}$ & $6.11\times10^{-4}$ & $9.83\times10^{-4}$ & $1.23\times10^{-2}$ & $5.01\times10^{-2}$ \\
