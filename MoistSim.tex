...
\begin{minipage}[t]{0.45\linewidth} 
    ...
    \caption{One-sided Hausdorff distance between thin shell simulations using our method (left), and our method with hinge-based shape operator (right), for meshes with 1277, 3594, and 5538 vertices.}
