...
\begin{figure}[h]
  ...
  \caption{Didactic {The exact solutions (white) and simulated surfaces (colored) from the didactic examples. From left to right are the enlarged square, rhombus, spherical cap, hyperboloid, and cylindrical patch experiments.}}
  \label{fig:didactic}
\end{figure}
