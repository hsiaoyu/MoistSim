...
We prescribe a differential growth of a thin slab of rectangular material with rest metric
$$\bar\bg =  (\frac{(1 + G)z}{h} + (1 - \frac{z}{h}))^2 \bar\bg_0$$
and show the energy comparison in Table~\ref{tab:energy}. Our energy follows closely to the St. Venant-Kirhoff energy compared to the method by ~\cite{Gingold04} and converges faster than FEM.

\begin{table*}
\begin{tabular}{lccccccc}
$G$ & $0.005$ & $0.03$ & $0.05$ & $0.08$ & $0.1$ & $0.3$ & $0.5$  \\
\hline
St.VK Energy & $1.6x10^{-6}$ & $5.64x10^{-5}$ & $1.55x10^{-4}$ & $3.87x10^{-4}$ & $5.974x10^{-4}$ & $4.77x10^{-3}$ & $1.2x10^{-2}$ \\
